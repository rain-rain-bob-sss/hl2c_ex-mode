...
if ( !file.IsDir( "half-life_2_campaign_ex", "DATA" ) ) then
	...
	file.CreateDir( "half-life_2_campaign_ex" )

end

if ( !file.IsDir( "half-life_2_campaign_ex/client", "DATA" ) ) then

	file.CreateDir( "half-life_2_campaign_ex/client" )
...
function PlayerInitialSpawn( len )
	...
	-- Shows the help menu
	if ( !file.Exists( "half-life_2_campaign_ex/client/shown_help.txt", "DATA" ) ) then
	
		ShowHelp( 0 )
		file.Write( "half-life_2_campaign_ex/client/shown_help.txt", "You've viewed the help menu in Half-Life 2 Campaign." )
